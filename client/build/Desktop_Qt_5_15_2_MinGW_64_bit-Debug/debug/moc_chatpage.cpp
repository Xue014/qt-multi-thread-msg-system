...
QT_MOC_LITERAL(4, 30, 19) // "onSendButtonClicked"

    },
    "ChatPage\0messageSent\0\0content\0"
    "onSendButtonClicked"
};
...
void ChatPage::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChatPage::messageSent)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChatPage::messageSent(const QString & _t1)
{
